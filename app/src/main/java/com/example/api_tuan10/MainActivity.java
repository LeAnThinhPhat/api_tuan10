package com.example.api_tuan10;
...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://60b5399dfe923b0017c83d20.mockapi.io/api/Student";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String urlGet="https://60b5399dfe923b0017c83d20.mockapi.io/api/Student";
                GetData(urlGet);
            }
        });
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDel="https://60b5399dfe923b0017c83d20.mockapi.io/api/Student";
                DeleteApi(urlDel);
            }
        });
        btnPut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlPost = "https://60b5399dfe923b0017c83d20.mockapi.io/api/Student";
                PostApi(urlPost);
            }
        });
    ...
    private void PostApi(String url){
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("name", "phat");
                params.put("username", "phat");
                params.put("password", "phat");
